...
export default function Passwordrest() {
    return(
        <main  className={`flex min-h-screen flex-col  items-center justify-between p-24 ${inter.className}`} >
            ...
            <span>Select which contact details should we use to <br /> reset the password</span>
           
            <div className="flex flex-col gap-5 mb-28">
            <button className=" bg-slate-300  rounded-2xl h-14 text-black flex-row flex items-center w-80 justify-start ml-7  "> 
            ...
            <button className=" bg-red-800 justify-center rounded-2xl h-10 text-white flex items-center w-80 ml-7 ">Next</button> 
        </main>
    )
